...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://nowy513.github.io/";
        ...
        driver.findElements(
                ...
                .filter(anyForm ->
                        anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]"))
                                .getText().equals(taskName))
                .forEach(theForm -> {
                    WebElement buttonDeleteCard = theForm.findElement(By.xpath(".//fieldset[contains(@class, \"button-section\")]/button[4]"));
